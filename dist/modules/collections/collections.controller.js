...
let CollectionsController = class CollectionsController {
    ...
    addItem(userId, collectionId, quoteId) {
        return this.collections.addToCollection(userId, collectionId, quoteId);
    }
    removeItem(userId, collectionId, quoteId) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], CollectionsController.prototype, "getMyFavorites", null);
__decorate([
    (0, common_1.Post)('favorites/:quoteId'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('quoteId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], CollectionsController.prototype, "toggleFavorite", null);
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
...
__decorate([
    (0, common_1.Post)(':collectionId/items/:quoteId'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
...
__decorate([
    (0, common_1.Delete)(':collectionId/items/:quoteId'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('collectionId')),
    __param(2, (0, common_1.Param)('quoteId')),
    __metadata("design:type", Function),
...
exports.CollectionsController = CollectionsController = __decorate([
    (0, common_1.Controller)('me/collections'),
